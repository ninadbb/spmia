...
public class SpecialRoutesFilter /*extends ZuulFilter*/ {
    ...
    public Object run() {
        ...
        logger.debug("SpecialRoutesFilter.run START");
        ...
        logger.debug("SpecialRoutesFilter.run END");
        return null;
    }

    private void forwardToSpecialRoute(String route) {
        logger.debug("SpecialRoutesFilter.forwardToSpecialRoute:{}", route);
